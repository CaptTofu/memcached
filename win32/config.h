...
#define PACKAGE_STRING "memcached 1.4.4-53-g0b7694c"

/* Define to the full name and version of this package. */
#define PACKAGE_DESCRIPTION "memcached 1.4.4-53-g0b7694c is a high-performance, distributed memory object caching system, generic in nature, but intended for use in speeding up dynamic web applications by alleviating database load. Win32 port by Kronuz."

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "memcached"

/* Define to the version of this package. */
#define PACKAGE_VERSION "1.4.4-53-g0b7694c"

/* Define to 1 if you have the ANSI C header files. */
#define STDC_HEADERS 1

/* Version number of package */
#define VERSION "1.4.4-53-g0b7694c"
